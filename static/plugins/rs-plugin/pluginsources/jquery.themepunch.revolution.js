	...
	jQuery.fn.extend({
						...
						if (!container.hasClass("revslider-initialised")) {
									...
									if (opt.lazyLoad!="on") {
										  ...
										  container.waitForImages(function() {
											...
											var fli = container.find('ul >li >images').first();
		...
		function createThumbs(container,opt) {
			...
			container.find('>ul:first >li').each(function(i) {
							...
							bullets.append('<div class="bullet thumb"><images src="'+src+'"></div>');
		...
		function prepareOneSlideV(slotholder,opt,visible) {
				...
				for (var i=0;i<opt.slots+2;i++)
					sh.append('<div class="slot" style="position:absolute;'+
												 ...
												 'left:0px;width:'+w+'px;'+
												 'height:'+opt.sloth+'px;'+
												 'overflow:hidden;"><images style="position:absolute;'+
		...
		function swapSlideProgress(container,opt) {
			...
			if (nexttrans==7) {
						...
						// ALL OLD SLOTS SHOULD BE SLIDED TO THE RIGHT
						actsh.find('.slotslide').each(function() {
							var ss=jQuery(this).find('images');
			...
			if (nexttrans==16) {						// PAPERCUT
					...
					setTimeout(function() {
								...
								if (actli.find('.tp-half-one').length>0)  {
									actli.find('.tp-half-one >images, .tp-half-one >div').unwrap();
